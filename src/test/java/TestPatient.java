...
public class TestPatient {
    ...
    String statusCOVID1 = "High";

    // Creates Entities.Patient object in all tests
    @BeforeEach
    public void setUp(){
        pat = new Patient(name1, DOB1, sex1, location1, ID1, statusCOVID1);
    }

    // GetCOVIDStatus() Test
    @Test
    public void testGetCOVIDStatus(){
        Assertions.assertEquals(statusCOVID1, pat.getCOVIDStatus());
    }
