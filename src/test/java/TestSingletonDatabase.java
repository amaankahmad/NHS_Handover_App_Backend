...
public class TestSingletonDatabase {
    ...
    public void testCreatePatient(){
        ...
        Patient p = new Patient(name3, DOB3, sex3, location3, numMRN3,statusCOVID3);
    ...
    public void testCreateTask(){
        ...
        db.createTask(pat3, senior4, notes4, history4, taskDescript4, time4, urgency4);
        Assertions.assertEquals(1, db.getCurrTaskList().size());
        Task t = db.getCurrTaskList().get(0);
        Task todo = new Task(pat3, senior4, notes4, history4, taskDescript4, time4, urgency4);
    ...
    public void testCreateFollowUp() {
        ...
        Task todo = new Task(pat3, senior4, notesIn, history4, taskDescript5, time5, urgency5);

        db.createFollowUp(t, senior4, notes5, taskDescript5, time5, urgency5);
    ...
    public void setUp(){
        ...
        db.createPatient(name3,DOB3,sex3,location3,numMRN3,statusCOVID3);
        pat = db.getPatientList().get(0);
        db.createTask(pat, senior4, notes4, history4, taskDescript4, time4,urgency4);
        t1 = db.getCurrTaskList().get(0);
        db.createTask(pat5, senior5, notes5, history5, taskDescript5, time5, urgency5);
